...
class CurrentOrdersFactory {
  ...
  CurrentOrders create({@required int customerId}) => CurrentOrders(
        stateProvider(),
...
class CurrentOrders extends StatefulWidget {
  ...
  CurrentOrders(this.state, {Key key, @required this.customerId})
      : super(key: key);
...
class CurrentOrdersState extends State<CurrentOrders> {
  ...
  Future<void> _fetchOrdersAndUpdateState(_) async {
    orders = await orderService.getOrdersByCustomerId(widget.customerId);
    setState(() {
